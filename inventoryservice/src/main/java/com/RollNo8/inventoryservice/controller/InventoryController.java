package com.RollNo8.inventoryservice.controller;
...
import com.RollNo8.inventoryservice.service.InventoryService;
...
public class InventoryController {
    ...
    public ResponseEntity<Void> updateEventCapacity(@PathVariable("eventId") Long eventId, @PathVariable("capacity") Long ticketBooked) {
